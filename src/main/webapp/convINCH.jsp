...
<html>
    ...
    <body>
        ...
        <form action="convert_inch" method="post">
            Inch: <input type="number" name="inch" required />
            <input type="submit" value="transforma in cm" />
        </div>
        </form>
        <div class="info"> 1 inch = 2.54 centimeteri</div>
    </body>
</html>
