...
<html>
    ...
    <body>
        ...
        <div align="center">
        <form action="convert_Mile" method="post">
            Mile: <input type="number" name="mile" required />
            <input type="submit" value="transforma in km" />
        </div>
        
        </form>
            <div class="info"> 1 mila = 1.609344 kilometri</div>
    </body>
</html>
